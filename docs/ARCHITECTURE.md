...
```mermaid
graph TD
    Pipeline[academic-pipeline<br/>orchestrator<br/>v3.9.4.2<br/>Agent Team: 5]
    ...
    AP[academic-paper<br/>12 agents<br/>v3.1.2<br/>+ corpus reader]
