...
> **插件更新后：** 若您执行 `/plugin update academic-research-skills@academic-research-skills`，扩展符号链接会自动指向更新后的源文件。
...
| 技能 | 用途 |
|-------|---------|
| `deep-research` v2.9.4 | 13个智能体的研究团队 — 7 种模式 |
| `academic-paper` v3.1.2 | 12个智能体的论文写作团队 — 10 种模式 |
| `academic-paper-reviewer` v1.9.1 | 多视角模拟同行评审 — 6 种模式 |
| `academic-pipeline` v3.9.4.2 | 完整的 10 阶段流程编排器 |
...
- **[docs/design/](docs/design/)** — 所有设计规格（v3.6.2 – v3.9.4.2 + Copilot 移植）
